...
export default function Tienda() {
  ...
  // Motor de filtrado y ordenamiento unificado
  useEffect(() => {
        ...
        <div className="h-64 bg-slate-950 relative overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 p-4 w-full">
            ...
            <div className="flex justify-between items-end mt-2">
              ...
              <Button icon="pi pi-cart-plus" rounded className="bg-sky-600 border-none hover:bg-sky-500 shadow-lg" onClick={() => agregarAlCarrito(juego)} disabled={(juego.stock ?? 0) <= 0} />
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10">
      ...
      {!loading && juegosOriginales.length > 0 && (
        <div className="mb-10">
          <h2 className="text-2xl font-black text-white mb-6 border-l-4 border-sky-500 pl-3">Juegos Populares</h2>
          <Carousel 
      ...
      <div>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <h2 className="text-2xl font-black text-white border-l-4 border-sky-500 pl-3">Explorar Catálogo</h2>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 border border-slate-800 rounded-2xl bg-slate-900/50">
            ...
            <p className="text-slate-400">Prueba con otro término o elimina los filtros.</p>
          </div>
        ) : (
